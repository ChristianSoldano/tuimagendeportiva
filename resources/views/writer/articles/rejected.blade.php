...
<h1>Artículos Rechazados</h1>

<div class="row">
    <div class="col-12">
        {!! Form::open(['route' => 'writer.articles.rejected', 'method' => 'GET', 'class' => 'form-inline my-2 my-lg-0'])!!}
        {!! Form::text('title',null, ['class' => 'form-control mr-sm-2', 'placeholder' => 'Título del artículo'])!!}
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Buscar</button>
        @if($search !=null)
        <a class="btn btn-danger my-2 my-sm-0 ml-2" href="{{route('writer.articles.rejected')}}" role="button"><i
