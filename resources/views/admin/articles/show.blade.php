...
<div class="container">
    ...
    <div class="d-flex justify-content-center">
        ...
        <a href="{{route('admin.articles.create')}}" class="btn btn-lg btn-primary"><span
                class="fa fa-plus mr-2"></span>Nuevo</a>

        <a href="{{route('admin.articles.edit', $article->id)}}" class="btn btn-lg btn-warning ml-3 mr-3
