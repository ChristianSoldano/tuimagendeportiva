...
<div class="row">
    <div class="col-12">
        {!! Form::open(['route' => 'admin.articles.rejected', 'method' => 'GET', 'class' => 'form-inline my-2 my-lg-0'])!!}
        {!! Form::text('title',null, ['class' => 'form-control mr-sm-2', 'placeholder' => 'Título del artículo'])!!}
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Buscar</button>
        @if($search !=null)
        <a class="btn btn-danger my-2 my-sm-0 ml-2" href="{{route('admin.articles.rejected')}}" role="button"><i
...
<div class="card mt-3">
    ...
    <div class="card-header">
        ...
        <a href="{{route('admin.articles.create')}}" class="btn btn-primary pull-right"><span
